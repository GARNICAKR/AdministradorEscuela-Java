...
public class Semestre {
    ...
    String brRead;
            try{
                FileReader fr=new FileReader("C:\\Users\\dell\\Desktop\\Sistema_Escuela_Definitivo\\txts\\Semestre.txt");
    ...
    public void Write(String texto){
             try{
                FileWriter fw=new FileWriter("C:\\Users\\dell\\Desktop\\Sistema_Escuela_Definitivo\\txts\\Semestre.txt",true);
     ...
     public void Write2(String texto){
             try{
                FileWriter fw=new FileWriter("C:\\Users\\dell\\Desktop\\Sistema_Escuela_Definitivo\\txts\\Semestre.txt",false);
                PrintWriter pw=new PrintWriter(fw); 
                pw.write(texto);
                pw.close();
            }catch(Exception e){
