...
public class Grupo {
    ...
    String brRead;
            try{
                FileReader fr=new FileReader("E:\\Dannysbtz\\Escritorio\\Sistema_Escuela\\txts\\grupo.txt");
    ...
    public void Write(String texto){
             try{
                FileWriter fw=new FileWriter("E:\\Dannysbtz\\Escritorio\\Sistema_Escuela\\txts\\grupo.txt",true);
     ...
     public void Write2(String texto){
             try{
                FileWriter fw=new FileWriter("E:\\Dannysbtz\\Escritorio\\Sistema_Escuela\\txts\\grupo.txt",false);
                PrintWriter pw=new PrintWriter(fw); 
                pw.write(texto);
                pw.close();
            }catch(Exception e){
